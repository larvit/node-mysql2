...
function ColumnDefinition (packet)
{
  ...
  // read the field
  this.name = StringParser.bufferToString(this._buf.slice(_nameStart, _nameStart + _nameLength), this.characterSet);
...
var addString = function (name) {
  Object.defineProperty(ColumnDefinition.prototype, name, {get: function () {
    ...
    return StringParser.bufferToString(this._buf.slice(start, end), this.characterSet);
  }});
};
